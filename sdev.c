...
const struct co_sdev lpc17xx_sdev = {
    ...
    .objs = (const struct co_sobj[]){
        ...
        {.name = CO_SDEV_STRING("Statusword"),
         ...
         .subs = (const struct co_ssub[]){
             {.name = CO_SDEV_STRING("Statusword"),
              ...
              .pdo_mapping = 1,
              .flags = 0}}},
         {.name = CO_SDEV_STRING("Mode of Operation"),
         .idx = 0x6060,
         .code = CO_OBJECT_VAR,
         .nsub = 1,
         .subs = (const struct co_ssub[]){
                               {.name = CO_SDEV_STRING("Mode of Operation"),
                                ...
                                .pdo_mapping = 1,
                                .flags = 0}}},
         {.name = CO_SDEV_STRING("Mode of Operation Display"),
         .idx = 0x6061,
         .code = CO_OBJECT_VAR,
         .nsub = 1,
         .subs = (const struct co_ssub[]){
       ...
       {.name = CO_SDEV_STRING("Homing Profile"),
       .idx = 0x6098,
       .code = CO_OBJECT_VAR,
       .nsub = 1,
       .subs = (const struct co_ssub[]){
       ...
       .subs = (const struct co_ssub[]){
                      {.name = CO_SDEV_STRING("Homing Acceleration"),
                       ...
                       .pdo_mapping = 1,
                       .flags = 0}}},
       {.name = CO_SDEV_STRING("Homing Velocity"),
       .idx = 0x6099,
       .code = CO_OBJECT_VAR,
       .nsub = 1,
       .subs = (const struct co_ssub[]){
                      {.name = CO_SDEV_STRING("Homing Velocity"),
                       ...
                       .pdo_mapping = 1,
                       .flags = 0}}},
       {.name = CO_SDEV_STRING("Profile Acceleration"),
       .idx = 0x6081,
       .code = CO_OBJECT_VAR,
       .nsub = 1,
       .subs = (const struct co_ssub[]){
       ...
       .subs = (const struct co_ssub[]){
                      {.name = CO_SDEV_STRING("Profile Velocity"),
                       ...
                       .pdo_mapping = 1,
                       .flags = 0}}},
      {.name = CO_SDEV_STRING("Software position limit"),
        .idx = 0x607D,
        .code = CO_OBJECT_ARRAY,
        .nsub = 2,
        .subs = (const struct co_ssub[]){
                             {.name = CO_SDEV_STRING("Min position limit"),
                              .subidx = 0x00,
                              .type = CO_DEFTYPE_UNSIGNED32,
                              .min = {.u32 = CO_UNSIGNED32_MIN},
                              .max = {.u32 = CO_UNSIGNED32_MAX},
                              ...
                              .pdo_mapping = 1,
                              .flags = 0},
                             {.name = CO_SDEV_STRING("Max position limit"),
                              .subidx = 0x01,
                              .type = CO_DEFTYPE_UNSIGNED32,
                              .min = {.u32 = CO_UNSIGNED32_MIN},
                              .max = {.u32 = CO_UNSIGNED32_MAX},
